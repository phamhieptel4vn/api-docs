...
/* harmony export */ });
/* harmony import */ var _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(93973);
...
/* harmony import */ var dayjs_plugin_isoWeek__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(24506);
...
/* harmony import */ var dayjs_plugin_customParseFormat__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(95166);
...
/* harmony import */ var dayjs_plugin_advancedFormat__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(93748);
...
const tasks = [];
const rawTasks = [];
const getCommonDb = () => _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.j;
const parseDirective = (statement, context, type) => {
  (0,_mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.k)(globalThis, statement, context, type);
};
const clear = function() {
  ...
  currentSection = "";
  rawTasks.length = 0;
  (0,_mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.m)();
};
...
const draw = function(text, id, version, diagObj) {
  const conf2 = (0,_mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.g)();
  const LEFT_MARGIN = conf2.leftMargin ? conf2.leftMargin : 50;
  diagObj.db.clear();
  diagObj.parser.parse(text + "\n");
  _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("timeline", diagObj.db);
  ...
  _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("task", tasks2);
  svgDraw.initGraphics(svg);
  const sections2 = diagObj.db.getSections();
  _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("sections", sections2);
  ...
  sections2.forEach(function(section) {
    ...
    _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("sectionHeight before draw", sectionHeight);
    maxSectionHeight = Math.max(maxSectionHeight, sectionHeight + 20);
  });
  let maxEventCount = 0;
  let maxEventLineLength = 0;
  _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("tasks.length", tasks2.length);
  for (const [i, task] of tasks2.entries()) {
    ...
    _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("taskHeight before draw", taskHeight);
  ...
  _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("maxSectionHeight before draw", maxSectionHeight);
  _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("maxTaskHeight before draw", maxTaskHeight);
  if (sections2 && sections2.length > 0) {
    sections2.forEach((section) => {
      ...
      _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("sectionNode", sectionNode);
      const sectionNodeWrapper = svg.append("g");
      const node = svgDraw.drawNode(sectionNodeWrapper, sectionNode, sectionNumber, conf2);
      _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("sectionNode output", node);
  ...
  _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("bounds", box);
  if (title) {
  ...
  (0,_mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.s)(
    void 0,
    svg,
...
const drawTasks = function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf2, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections) {
  for (const task of tasks2) {
    ...
    _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("taskNode", taskNode);
    const taskWrapper = diagram2.append("g").attr("class", "taskWrapper");
    const node = svgDraw.drawNode(taskWrapper, taskNode, sectionColor, conf2);
    const taskHeight = node.height;
    _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("taskHeight after draw", taskHeight);
    ...
    masterX = masterX + 200;
    if (isWithoutSections && !(0,_mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.g)().timeline.disableMulticolor) {
      sectionColor++;
    }
  }
  masterY = masterY - 10;
...
const drawEvents = function(diagram2, events, sectionColor, masterX, masterY, conf2) {
  ...
  for (const event of events) {
    ...
    _mermaid_0a0d5cc4_js__WEBPACK_IMPORTED_MODULE_11__.l.debug("eventNode", eventNode);
